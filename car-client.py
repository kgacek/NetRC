    ...
    async def recv(self):
        ...
        while True:
            try:
                ...
                # Stream ended, should not happen with timeout=0
                logger.error("Hardware encoder stream ended unexpectedly")
                raise StopAsyncIteration
            except Exception as e:
                logger.error(f"Error reading from hardware encoder: {e}")
                raise
