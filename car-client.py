...
# Video resolution - use environment variable to override
# export VIDEO_WIDTH=1640 VIDEO_HEIGHT=1232 for higher res
W = int(os.getenv('VIDEO_WIDTH', '640'))
H = int(os.getenv('VIDEO_HEIGHT', '480'))
