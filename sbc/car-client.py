...
def set_remote_description_then_answer(sdp_type: str, sdp_text: str):
    if webrtc is None:
        return
    ...
    # WAŻNE: czekamy aż remote SDP faktycznie się ustawi, dopiero potem robimy answer
...
def on_set_remote_done(promise: Gst.Promise, *_):
    # remote SDP ustawione -> tworzymy answer
    if webrtc is None:
        return
    ...
    webrtc.emit("create-answer", None, prom)
